    ...
    const STRINGS = {
      ru: {
        ...
        faq_text1:'Добавляй желания по фото, ссылке или тексту — AI проанализирует и заполнит поля. Или вводи всё вручную. Кнопки справа или во вкладке Желания.',
        faq_text2:'Создавай листы и лейблы во вкладках, шерь с друзьями, букай желания.<br><br>Обратная связь — @tcndtht<br>Наслаждайся!',
      ...
      en: {
        ...
        faq_text2:'Create lists and labels in the tabs, share with friends, claim wishes.<br><br>Share your feedback at @tcndtht<br>Enjoy!',
